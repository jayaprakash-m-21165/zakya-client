...
export const Logo = ({ size = 36, height, className = "", ...props }) => {
  const { theme } = useTheme();
  
  const logoUrl = theme === "dark" 
    ? "https://oweb.zohowebstatic.com/sites/oweb/images/zakya/zakya-logo-black.svg" 
    : "https://oweb.zohowebstatic.com/sites/oweb/images/zakya/zakya-logo-white.svg";
